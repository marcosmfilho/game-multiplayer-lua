...
function listbox:additem(str,data,update, player)
...
love.graphics.print(tmpf, self.x+self.paddingw, index)
...
function listbox:draw(player)
	...
	for i=1, #self.tlist do
			if self.cor[i] == 'player1' then
				love.graphics.setColor(102, 0, 204)
				listbox:drawtext(i,x,y,self.ispress)
			else
				love.graphics.setColor(179, 0, 59)
				listbox:drawtext(i,x,y,self.ispress)
			end
	 end
	end
